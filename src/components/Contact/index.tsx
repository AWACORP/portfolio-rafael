        ...
        <div className="container mx-auto px-4 mb-12 md:mb-0">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <motion.div initial={{ opacity: 0, x: -120 }}
                    ...
                    <h1 className="text-5xl lg:text-7xl font-bold mb-4">Discutons de <br /> votre projet</h1>
                    ...
                    <div className="flex justify-center items-center flex-col my-5">
                        <h1 className="text-xl md:text-2xl font-bold mb-4">Ils m&apos;ont fait confiance, pourquoi pas vous?</h1>
                        <div className="flex justify-center items-center gap-10" style={{ width: "100%" }}>
                            <Image src="/dgac.png" alt="" style={{ width: "auto", height: "48px" }} width={1920} height={1080} />
                            <Image src="/unairdeclope.png" alt="" style={{ width: "auto", height: "48px" }} width={1920} height={1080} />
                            <Image src="/lacitadelle.png" alt="" style={{ width: "auto", height: "48px" }} width={1920} height={1080} />
                        </div>
                    </div>
                </motion.div>
                <motion.div initial={{ opacity: 0, x: 120 }}
