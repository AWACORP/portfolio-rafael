        ...
        <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <motion.div
                    ...
                    <div className="flex max-lg:justify-start max-md:justify-center max-sm:justify-center gap-4">
                ...
                <motion.div
                    ...
                    <Link href="/about" className="mt-5 direct-link" prefetch> Voir toute mes compétences <FontAwesomeIcon icon={faArrowRight} /></Link>
                </motion.div>
